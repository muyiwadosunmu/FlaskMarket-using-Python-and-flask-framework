    ...
    if request.method == "POST":
        ...
        if p_item_object:
            if current_user.can_purchase(p_item_object):
                ...
                flash(f"Insufficient amount to buy {p_item_object.name}", category='danger')
        #  sell item logic
        ...
        if s_item_object:
            if current_user.can_sell(s_item_object):
                ...
                flash(f"Something went wrong in sekking {s_item_object.name}", category='danger')
...
def login_page():
    ...
    if form.validate_on_submit():
        ...
        if attempted_user and attempted_user.check_password_correction(
            ...
            flash('Username and Password not synchronized, please check', category='danger')
